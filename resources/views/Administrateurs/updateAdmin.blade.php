        ...
        <body>
            ...
            <div class="container" style="margin-top: 130px;">
                <div class="container d-flex flex-column align-items-center">
                    <form method="POST" action="/updateAdmin/traitement">
                        @csrf
                        <input type="text" name="id" style="display: none;" value="{{$admins->id}}">
                        <label for="exampleInputNom1" class="form-label">Nom & Prénom</label>
                        <input type="text" class="form-control" id="exampleNom1" name="nom"
                            aria-describedby="emailHelp" value="{{$admins->nom}}">

                        <div class="mb-3">
                            <label for="exampleInputEmail" class="form-label">Email</label>
                            <input type="email" class="form-control" id="exampleInputEmail" name="email"
                                aria-describedby="emailHelp"value="{{$admins->email}}">
                        </div>
                        <div class="mb-3">
                            ...
                            <input type="password" class="form-control" id="exampleInputEmail" name="motdepasse"
                                aria-describedby="emailHelp" value="{{$admins->motdepasse}}">
                        </div>
