...
<body>
    ...
    <div class="container-fluid mt-5 fond">
            ...
            <div class="row">
                @foreach ($produits as $produit)
                    <div class="col-12 col-sm-6 col-md-4 col-lg-3 mb-4">
                        <div class="card" style="background-image: url('{{ asset('Images/Tracé 8.png') }}'); background-size: cover; background-position: center; border: none; border-radius: 20px;">
                            @if ($produit->images->isNotEmpty())
                                @php
                                    $imagePath = Storage::url($produit->images->first()->image_path);
                                @endphp
                                <img src="{{ $imagePath }}" class="card-img-top" alt="{{ $produit->name }}">
                            @endif
                            <div class="card-body d-flex flex-column" style="color: white;">
                                ...
                                <form action="{{ route('panier.ajouter') }}" method="POST">
                                    ...
                                    <div class="d-flex justify-content-between">
                                        <a href="{{ route('produit.details', ['id' => $produit->id]) }}" class="btn mt-2" style="background-color: white; border-radius: 50px; font-weight: 600;">Voir le produit</a>
                                        <button type="submit" class="btn help">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" style="color: white;" fill="currentColor" class="bi bi-cart3" viewBox="0 0 16 16">
                                                <path d="M0 1.5A.5.5 0 0 1 .5 1H2a.5.5 0 0 1 .485.379L2.89 3H14.5a.5.5 0 0 1 .49.598l-1 5a.5.5 0 0 1-.465.401l-9.397.472L4.415 11H13a.5.5 0 0 1 0 1H4a.5.5 0 0 1-.491-.408L2.01 3.607 1.61 2H.5a.5.5 0 0 1-.5-.5M3.102 4l.84 4.479 9.144-.459L13.89 4zM5 12a2 2 0 1 0 0 4 2 2 0 0 0 0-4m7 0a2 2 0 1 0 0 4 2 2 0 0 0 0-4m-7 1a1 1 0 1 1 0 2 1 1 0 0 1 0-2m7 0a1 1 0 1 1 0 2 1 1 0 0 1 0-2"/>
                                            </svg>
                                        </button>
                                    </div>
    ...
    <footer>
        <div class="container-fluid text-white pied">
